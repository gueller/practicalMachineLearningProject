...
```{r correlationMatrix, echo=TRUE, message=FALSE, warning=FALSE, out.width="75%", out.height="75%", fig.height=12, fig.width=10, fig.align='left'}
...
##### fig 2. - Decision Tree
```{r modelDecisionTree, echo=TRUE, message=FALSE, warning=FALSE, fig.width=10, fig.height=6, fig.align='left'}
...
```{r prettyPrintTable, echo=TRUE, warning=FALSE, message=FALSE}
# Pretty output
...
```{r quizAnswers, echo=TRUE, warning=FALSE, message=FALSE}
